...
public class RobotParser {
    ...
    public RobotParser(HashMap<String,Integer> AMap, HashMap<String,Integer> NAMap, HashMap<String,Float> delayValue, String filepath) throws FileNotFoundException{
        
        myAMap = AMap;
        myNAMap = NAMap;
        myDelayValue= delayValue;
        agentsProcessed = new ArrayList<>();
